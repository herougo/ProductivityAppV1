...
- [x] 02 - **Configure Django app** - Add productivity_core to INSTALLED_APPS in settings.py
...
- [x] 07 - **Create default workflow states setup** - Add management command to create default workflow states
